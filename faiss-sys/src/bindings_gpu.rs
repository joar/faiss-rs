...
extern "C" {
    ...
    pub fn faiss_IndexIDMap_id_map(
        ...
        p_id_map: *mut *mut ::std::os::raw::c_long,
        p_size: *mut usize,
    );
}
#[repr(C)]
...
extern "C" {
    pub fn faiss_IndexShards_threaded(arg1: *const FaissIndexShards) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn faiss_IndexShards_set_threaded(arg1: *mut FaissIndexShards, arg2: ::std::os::raw::c_int);
}
extern "C" {
...
extern "C" {
    ...
    pub fn faiss_IndexShards_shard_indexes(
